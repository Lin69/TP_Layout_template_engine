...
//TODO: Уточнить про файловую структуру, узнать про PIMPL, множественное наследование, кастомные блоки, доделать uml, продумать presenter, переделать тесты, сделать каскад и тесты для presenter, код