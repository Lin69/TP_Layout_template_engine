...
block_model::Select::Select()
    : multiple_attr(false), size_attr(0), required_attr(false) {}
...
block_model::Select& block_model::Select::operator=(
    const block_model::Select& src) {
  if (this == &src) {
    return *this;
  }
...
void block_model::Select::SetMultiple(bool value) { multiple_attr = value; }

void block_model::Select::SetSize(const int& new_size) { size_attr = new_size; }

void block_model::Select::SetRequired(bool value) { required_attr = value; }

void block_model::Select::SetTagContent(
