#include <block_model/textarea.h>

block_model::Textarea::Textarea()
    : cols(0), rows(0), maxlength(0), readonly(false), required_attr(false) {}
...
block_model::Textarea& block_model::Textarea::operator=(
    const block_model::Textarea& src) {
  if (this == &src) {
    return *this;
  }
...
void block_model::Textarea::SetCols(const int& new_cols) { cols = new_cols; }

void block_model::Textarea::SetRows(const int& new_rows) { rows = new_rows; }

void block_model::Textarea::SetMaxlength(const int& new_maxlength) {
  maxlength = new_maxlength;
}

void block_model::Textarea::SetPlaceholder(
    const block_model::String& new_placeholder) {
  placeholder.str = new_placeholder.str;
}

void block_model::Textarea::SetReadonly(bool value) { readonly = value; }

void block_model::Textarea::SetRequired(bool value) { required_attr = value; }
